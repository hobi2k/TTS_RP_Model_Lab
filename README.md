...
- [LLM + TTS 적용 비주얼노벨 앱 시연 영상(사야)](https://drive.google.com/file/d/1sqcPd1M9Qma_-329d8Dm8ut2o97UI0Nf/view?usp=sharing)
- [LLM + TTS 적용 비주얼노벨 앱 시연 영상(마이)](https://drive.google.com/file/d/1MYchMs58PddVVR7uHrwyfnkPoRDMJ3V4/view?usp=sharing)


### saya_rp_4b_v2 시연 영상

- 기반 모델: `qwen/qwen3-4b` (Qwen3 계열)
- 주의: 7b 모델과 동일한 데이터셋으로 학습되었으나, 한국어 능력이 뒤떨어집니다.  
...
- FastAPI + REST + Gradio 데모 구조: [문서](system/webapi/api_architecture.md)
