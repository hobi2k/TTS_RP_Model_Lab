...
def main() -> None:
    ...
    ap.add_argument("--out_path", default="/mnt/d/rp_data/singleturn/rp_generated.jsonl")
    ap.add_argument("--progress_path", default="/mnt/d/rp_data/singleturn/rp_generated.progress.json")
    ...
    with open(args.out_path, "a", encoding="utf-8") as fout:
        for i in tqdm(range(start, args.target_rows), desc="SINGLETURN GPT GEN"):
            ok = False
