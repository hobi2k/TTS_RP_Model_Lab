...
- [slice.py](/home/ahnhs2k/pytorch-demo/saya_char_qwen2.5/models/Style-BERT-VITS2/slice.py)
...
[slice.py](/home/ahnhs2k/pytorch-demo/saya_char_qwen2.5/models/Style-BERT-VITS2/slice.py)는 `torch.hub.load(...)`로 `litagin02/silero-vad`를 불러온다.
...
- `slice.py` 실행 전에는 [slice.py](/home/ahnhs2k/pytorch-demo/saya_char_qwen2.5/models/Style-BERT-VITS2/slice.py)의 shim 코드가 제거되지 않았는지 확인한다.
