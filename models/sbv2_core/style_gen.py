"""
훈련 전에 bert_gen과 함께 돌려야 한다. 문제는 RTX5080...

uv run --active style_gen.py -c configs/config_jp_extra.json

python style_gen.py -c configs/config_jp_extra.json


CUDA_VISIBLE_DEVICES= python style_gen.py -c configs/config_jp_extra.json
"""
